...
### API Integration Tests (Hono Example)

Hono provides a native `app.request()` method to test endpoints without starting an HTTP server or using external tools like `supertest`:
