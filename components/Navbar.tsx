    ...
    >
      <div className="max-w-[1440px] w-full mx-auto px-12 md:px-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[var(--color-japan-red)] flex items-center justify-center text-white">
          ...
          <div className="flex flex-col">
            <span className="text-xs tracking-[0.2em] text-[var(--color-secondary-text)]">JOURNEY TO</span>
            <span className="font-heading text-xl tracking-wider text-[var(--color-japan-red)] font-semibold">MASTERY</span>
          </div>
        </div>
